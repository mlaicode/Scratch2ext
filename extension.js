(function(ext) {
    ...
    function getStatus(callback) {
        ...
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/2f9a0bb0-fcf2-11e8-af3f-3b09e008a7bb3868a006-4339-478f-8293-40cad04a7ac9/status',
            dataType : 'jsonp',
            headers : {
    ...
    function classifyText(text, cacheKey, lastmodified, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/2f9a0bb0-fcf2-11e8-af3f-3b09e008a7bb3868a006-4339-478f-8293-40cad04a7ac9/classify',
            dataType : 'jsonp',
            data : {
                data : text
            },
    ...
    function storeText(text, label, callback) {
        $.ajax({
            url : 'https://machinelearningforkids.co.uk/api/scratch/2f9a0bb0-fcf2-11e8-af3f-3b09e008a7bb3868a006-4339-478f-8293-40cad04a7ac9/train',
            dataType : 'jsonp',
            headers : {
                'X-User-Agent': 'mlforkids-scratch2-text'
            },
    ...
    var descriptor = {
        blocks : [
            ...
            [ 'r', 'Happy', 'return_label_0'],
            [ 'r', 'angry', 'return_label_1'],
            [ 'w', 'add training data %s to %m.labels', 'text_store', 'text', 'Happy'],
    ...
    ScratchExtensions.register('emotion', descriptor, ext);
